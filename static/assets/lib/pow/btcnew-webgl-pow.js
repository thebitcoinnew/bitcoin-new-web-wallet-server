// btcnew-webgl-pow
// Btcnew Currency Proof of Work Value generation using WebGL2
// Author:  numtel <ben@latenightsketches.com>
// License: MIT

// window.BtcnewWebglPow(hashHex, callback, progressCallback);
...
function calculate(hashHex, callback, progressCallback) {
  ...
  canvas.width = window.BtcnewWebglPow.width;
  canvas.height = window.BtcnewWebglPow.height;
